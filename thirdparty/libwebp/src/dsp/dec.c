...
{
    if ( in[0 * 16] ) {
        VP8TransformDC ( in + 0 * 16, dst );
    }
    if ( in[1 * 16] ) {
        VP8TransformDC ( in + 1 * 16, dst + 4 );
    }
    if ( in[2 * 16] ) {
        VP8TransformDC ( in + 2 * 16, dst + 4 * BPS );
    }
    if ( in[3 * 16] ) {
        VP8TransformDC ( in + 3 * 16, dst + 4 * BPS + 4 );
    }
}
                                        ...
                                        int step, int t, int it )
{
    ...
    if ( ( 4 * VP8kabs0[p0 - q0] + VP8kabs0[p1 - q1] ) > t ) {
        return 0;
    }
