...
static void TM4_NEON ( uint8_t* dst )
{
    TrueMotion_NEON ( dst, 4 );
}
...
static void DC8uv_NEON ( uint8_t* dst )
{
    DC8_NEON ( dst, 1, 1 );
}
static void DC8uvNoTop_NEON ( uint8_t* dst )
{
    DC8_NEON ( dst, 0, 1 );
}
static void DC8uvNoLeft_NEON ( uint8_t* dst )
{
    DC8_NEON ( dst, 1, 0 );
}
static void DC8uvNoTopLeft_NEON ( uint8_t* dst )
{
    DC8_NEON ( dst, 0, 0 );
}

static void TM8uv_NEON ( uint8_t* dst )
{
    TrueMotion_NEON ( dst, 8 );
}
...
static void DC16TopLeft_NEON ( uint8_t* dst )
{
    DC16_NEON ( dst, 1, 1 );
}
static void DC16NoTop_NEON ( uint8_t* dst )
{
    DC16_NEON ( dst, 0, 1 );
}
static void DC16NoLeft_NEON ( uint8_t* dst )
{
    DC16_NEON ( dst, 1, 0 );
}
static void DC16NoTopLeft_NEON ( uint8_t* dst )
{
    DC16_NEON ( dst, 0, 0 );
}
