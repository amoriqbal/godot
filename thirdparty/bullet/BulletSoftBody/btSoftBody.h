...
Link :
    ...
    struct Body {
        ...
        const btMatrix3x3& invWorldInertia() const
        {
            ...
            if ( m_rigid ) {
                return ( m_rigid->getInvInertiaTensorWorld() );
            }
            if ( m_soft ) {
                return ( m_soft->m_invwi );
            }
            return ( iwi );
        }
        ...
        {
            if ( m_rigid ) {
                return ( m_rigid->getInvMass() );
            }
            if ( m_soft ) {
                return ( m_soft->m_imass );
            }
            return ( 0 );
        }
        const btTransform& xform() const
        {
            ...
            if ( m_collisionObject ) {
                return ( m_collisionObject->getWorldTransform() );
            }
            if ( m_soft ) {
                return ( m_soft->m_framexform );
            }
            return ( identity );
        }
        ...
        {
            if ( m_rigid ) {
                return ( m_rigid->getLinearVelocity() );
            }
            if ( m_soft ) {
                return ( m_soft->m_lv );
            }
        ...
        {
            if ( m_rigid ) {
                return ( btCross ( m_rigid->getAngularVelocity(), rpos ) );
            }
            if ( m_soft ) {
                return ( btCross ( m_soft->m_av, rpos ) );
            }
            return ( btVector3 ( 0, 0, 0 ) );
        }
        ...
        {
            if ( m_rigid ) {
                return ( m_rigid->getAngularVelocity() );
            }
            if ( m_soft ) {
                return ( m_soft->m_av );
            }
        ...
        {
            if ( m_rigid ) {
                m_rigid->applyImpulse ( impulse, rpos );
            }
            if ( m_soft ) {
                btSoftBody::clusterVImpulse ( m_soft, rpos, impulse );
            }
        }
        void applyDImpulse ( const btVector3& impulse, const btVector3& rpos ) const
        {
            ...
            if ( m_soft ) {
                btSoftBody::clusterDImpulse ( m_soft, rpos, impulse );
            }
        }
        ...
        {
            if ( m_rigid ) {
                m_rigid->applyTorqueImpulse ( impulse );
            }
            if ( m_soft ) {
                btSoftBody::clusterVAImpulse ( m_soft, impulse );
            }
        }
        void applyDAImpulse ( const btVector3& impulse ) const
        {
            ...
            if ( m_soft ) {
                btSoftBody::clusterDAImpulse ( m_soft, impulse );
            }
        }
        void applyAImpulse ( const Impulse& impulse ) const
        {
            if ( impulse.m_asVelocity ) {
                applyVAImpulse ( impulse.m_velocity );
            }
            if ( impulse.m_asDrift ) {
                applyDAImpulse ( impulse.m_drift );
            }
        }
        void applyDCImpulse ( const btVector3& impulse ) const
        {
            if ( m_rigid ) {
                m_rigid->applyCentralImpulse ( impulse );
            }
            if ( m_soft ) {
                btSoftBody::clusterDCImpulse ( m_soft, impulse );
            }
        }
    };
    /* Joint		*/
