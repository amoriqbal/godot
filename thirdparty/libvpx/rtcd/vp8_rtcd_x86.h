...
static void setup_rtcd_internal ( void )
{
    ...
    if ( flags & HAS_MMX ) {
        vp8_bilinear_predict16x16 = vp8_bilinear_predict16x16_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_bilinear_predict8x8 = vp8_bilinear_predict8x8_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_clear_system_state = vpx_reset_mmx_state;
    }
    vp8_copy_mem16x16 = vp8_copy_mem16x16_c;
    if ( flags & HAS_MMX ) {
        vp8_copy_mem16x16 = vp8_copy_mem16x16_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_dequant_idct_add_uv_block = vp8_dequant_idct_add_uv_block_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_dequant_idct_add_y_block = vp8_dequant_idct_add_y_block_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_bh = vp8_loop_filter_bh_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_bv = vp8_loop_filter_bv_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_mbh = vp8_loop_filter_mbh_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_mbv = vp8_loop_filter_mbv_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_simple_bh = vp8_loop_filter_bhs_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_simple_bv = vp8_loop_filter_bvs_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_simple_mbh = vp8_loop_filter_simple_horizontal_edge_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_loop_filter_simple_mbv = vp8_loop_filter_simple_vertical_edge_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_short_inv_walsh4x4 = vp8_short_inv_walsh4x4_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_sixtap_predict16x16 = vp8_sixtap_predict16x16_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_sixtap_predict8x4 = vp8_sixtap_predict8x4_mmx;
    }
    if ( flags & HAS_SSE2 ) {
    ...
    if ( flags & HAS_MMX ) {
        vp8_sixtap_predict8x8 = vp8_sixtap_predict8x8_mmx;
    }
    if ( flags & HAS_SSE2 ) {
