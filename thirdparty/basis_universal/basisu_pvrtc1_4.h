...
public:
    ...
    inline const pvrtc4_block_vector2D &get_blocks() const
    {
        return m_blocks;
    }
    inline		 pvrtc4_block_vector2D &get_blocks()
    {
        return m_blocks;
    }
    ...
    {
        return m_block_width * m_block_height;
    }
    ...
    inline void set_uses_alpha ( bool uses_alpha )
    {
        m_uses_alpha = uses_alpha;
    }
