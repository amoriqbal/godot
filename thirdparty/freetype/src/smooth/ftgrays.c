 ...
 *
 * B??zier segments are flattened by splitting them until their deviation
 * from straight line becomes much smaller than a pixel.  Therefore, the
 * pixel coverage by a B??zier curve is calculated approximately.  To
 ...
 *   segments and B??zier arcs.  This function is also able to emit
