...
struct FloatProxyTraits<Float16> {
    ...
    {
        return Float16::isNan ( f );
    }
    // Returns true if the given value is any kind of infinity.
    static bool isInfinity ( Float16 f )
    {
        return Float16::isInfinity ( f );
    }
    // Returns the maximum normal value.
    static Float16 max()
    {
...
public:
    ...
    bool isNan()
    {
        return FloatProxyTraits<T>::isNan ( getAsFloat() );
    }
    // Returns true if the value represents any type of infinity.
    bool isInfinity()
    {
        return FloatProxyTraits<T>::isInfinity ( getAsFloat() );
    }
...
public:
    ...
    {
        return spvutils::BitwiseCast<uint_type> ( value_ );
    }
