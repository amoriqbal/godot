...
VKAPI_ATTR void* VKAPI_CALL loader_lookup_device_dispatch_table ( const VkLayerDispatchTable *table, const char *name )
{
    ...
    if ( !strcmp ( name, "CreateSwapchainKHR" ) ) {
        return ( void * ) table->CreateSwapchainKHR;
    }
    ...
    if ( !strcmp ( name, "GetDeviceGroupPresentCapabilitiesKHR" ) ) {
        return ( void * ) table->GetDeviceGroupPresentCapabilitiesKHR;
    }
    if ( !strcmp ( name, "GetDeviceGroupSurfacePresentModesKHR" ) ) {
        return ( void * ) table->GetDeviceGroupSurfacePresentModesKHR;
    }
    if ( !strcmp ( name, "AcquireNextImage2KHR" ) ) {
        return ( void * ) table->AcquireNextImage2KHR;
    }

    // ---- VK_KHR_display_swapchain extension commands
    if ( !strcmp ( name, "CreateSharedSwapchainsKHR" ) ) {
        return ( void * ) table->CreateSharedSwapchainsKHR;
    }

    // ---- VK_KHR_device_group extension commands
    if ( !strcmp ( name, "GetDeviceGroupPeerMemoryFeaturesKHR" ) ) {
        return ( void * ) table->GetDeviceGroupPeerMemoryFeaturesKHR;
    }
    if ( !strcmp ( name, "CmdSetDeviceMaskKHR" ) ) {
        return ( void * ) table->CmdSetDeviceMaskKHR;
    }
    if ( !strcmp ( name, "CmdDispatchBaseKHR" ) ) {
        return ( void * ) table->CmdDispatchBaseKHR;
    }

    // ---- VK_KHR_maintenance1 extension commands
    if ( !strcmp ( name, "TrimCommandPoolKHR" ) ) {
        return ( void * ) table->TrimCommandPoolKHR;
    }

    // ---- VK_KHR_external_memory_win32 extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetMemoryWin32HandleKHR" ) ) {
        return ( void * ) table->GetMemoryWin32HandleKHR;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetMemoryWin32HandlePropertiesKHR" ) ) {
        return ( void * ) table->GetMemoryWin32HandlePropertiesKHR;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR

    // ---- VK_KHR_external_memory_fd extension commands
    if ( !strcmp ( name, "GetMemoryFdKHR" ) ) {
        return ( void * ) table->GetMemoryFdKHR;
    }
    if ( !strcmp ( name, "GetMemoryFdPropertiesKHR" ) ) {
        return ( void * ) table->GetMemoryFdPropertiesKHR;
    }

    // ---- VK_KHR_external_semaphore_win32 extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "ImportSemaphoreWin32HandleKHR" ) ) {
        return ( void * ) table->ImportSemaphoreWin32HandleKHR;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetSemaphoreWin32HandleKHR" ) ) {
        return ( void * ) table->GetSemaphoreWin32HandleKHR;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR

    // ---- VK_KHR_external_semaphore_fd extension commands
    if ( !strcmp ( name, "ImportSemaphoreFdKHR" ) ) {
        return ( void * ) table->ImportSemaphoreFdKHR;
    }
    if ( !strcmp ( name, "GetSemaphoreFdKHR" ) ) {
        return ( void * ) table->GetSemaphoreFdKHR;
    }

    // ---- VK_KHR_push_descriptor extension commands
    if ( !strcmp ( name, "CmdPushDescriptorSetKHR" ) ) {
        return ( void * ) table->CmdPushDescriptorSetKHR;
    }
    if ( !strcmp ( name, "CmdPushDescriptorSetWithTemplateKHR" ) ) {
        return ( void * ) table->CmdPushDescriptorSetWithTemplateKHR;
    }

    // ---- VK_KHR_descriptor_update_template extension commands
    if ( !strcmp ( name, "CreateDescriptorUpdateTemplateKHR" ) ) {
        return ( void * ) table->CreateDescriptorUpdateTemplateKHR;
    }
    if ( !strcmp ( name, "DestroyDescriptorUpdateTemplateKHR" ) ) {
        return ( void * ) table->DestroyDescriptorUpdateTemplateKHR;
    }
    if ( !strcmp ( name, "UpdateDescriptorSetWithTemplateKHR" ) ) {
        return ( void * ) table->UpdateDescriptorSetWithTemplateKHR;
    }

    // ---- VK_KHR_create_renderpass2 extension commands
    if ( !strcmp ( name, "CreateRenderPass2KHR" ) ) {
        return ( void * ) table->CreateRenderPass2KHR;
    }
    if ( !strcmp ( name, "CmdBeginRenderPass2KHR" ) ) {
        return ( void * ) table->CmdBeginRenderPass2KHR;
    }
    if ( !strcmp ( name, "CmdNextSubpass2KHR" ) ) {
        return ( void * ) table->CmdNextSubpass2KHR;
    }
    if ( !strcmp ( name, "CmdEndRenderPass2KHR" ) ) {
        return ( void * ) table->CmdEndRenderPass2KHR;
    }

    // ---- VK_KHR_shared_presentable_image extension commands
    if ( !strcmp ( name, "GetSwapchainStatusKHR" ) ) {
        return ( void * ) table->GetSwapchainStatusKHR;
    }

    // ---- VK_KHR_external_fence_win32 extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "ImportFenceWin32HandleKHR" ) ) {
        return ( void * ) table->ImportFenceWin32HandleKHR;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetFenceWin32HandleKHR" ) ) {
        return ( void * ) table->GetFenceWin32HandleKHR;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR

    // ---- VK_KHR_external_fence_fd extension commands
    if ( !strcmp ( name, "ImportFenceFdKHR" ) ) {
        return ( void * ) table->ImportFenceFdKHR;
    }
    if ( !strcmp ( name, "GetFenceFdKHR" ) ) {
        return ( void * ) table->GetFenceFdKHR;
    }

    // ---- VK_KHR_performance_query extension commands
    if ( !strcmp ( name, "AcquireProfilingLockKHR" ) ) {
        return ( void * ) table->AcquireProfilingLockKHR;
    }
    if ( !strcmp ( name, "ReleaseProfilingLockKHR" ) ) {
        return ( void * ) table->ReleaseProfilingLockKHR;
    }

    // ---- VK_KHR_get_memory_requirements2 extension commands
    if ( !strcmp ( name, "GetImageMemoryRequirements2KHR" ) ) {
        return ( void * ) table->GetImageMemoryRequirements2KHR;
    }
    if ( !strcmp ( name, "GetBufferMemoryRequirements2KHR" ) ) {
        return ( void * ) table->GetBufferMemoryRequirements2KHR;
    }
    if ( !strcmp ( name, "GetImageSparseMemoryRequirements2KHR" ) ) {
        return ( void * ) table->GetImageSparseMemoryRequirements2KHR;
    }

    // ---- VK_KHR_sampler_ycbcr_conversion extension commands
    if ( !strcmp ( name, "CreateSamplerYcbcrConversionKHR" ) ) {
        return ( void * ) table->CreateSamplerYcbcrConversionKHR;
    }
    if ( !strcmp ( name, "DestroySamplerYcbcrConversionKHR" ) ) {
        return ( void * ) table->DestroySamplerYcbcrConversionKHR;
    }

    // ---- VK_KHR_bind_memory2 extension commands
    if ( !strcmp ( name, "BindBufferMemory2KHR" ) ) {
        return ( void * ) table->BindBufferMemory2KHR;
    }
    if ( !strcmp ( name, "BindImageMemory2KHR" ) ) {
        return ( void * ) table->BindImageMemory2KHR;
    }

    // ---- VK_KHR_maintenance3 extension commands
    if ( !strcmp ( name, "GetDescriptorSetLayoutSupportKHR" ) ) {
        return ( void * ) table->GetDescriptorSetLayoutSupportKHR;
    }

    // ---- VK_KHR_draw_indirect_count extension commands
    if ( !strcmp ( name, "CmdDrawIndirectCountKHR" ) ) {
        return ( void * ) table->CmdDrawIndirectCountKHR;
    }
    if ( !strcmp ( name, "CmdDrawIndexedIndirectCountKHR" ) ) {
        return ( void * ) table->CmdDrawIndexedIndirectCountKHR;
    }

    // ---- VK_KHR_timeline_semaphore extension commands
    if ( !strcmp ( name, "GetSemaphoreCounterValueKHR" ) ) {
        return ( void * ) table->GetSemaphoreCounterValueKHR;
    }
    if ( !strcmp ( name, "WaitSemaphoresKHR" ) ) {
        return ( void * ) table->WaitSemaphoresKHR;
    }
    if ( !strcmp ( name, "SignalSemaphoreKHR" ) ) {
        return ( void * ) table->SignalSemaphoreKHR;
    }

    // ---- VK_KHR_buffer_device_address extension commands
    if ( !strcmp ( name, "GetBufferDeviceAddressKHR" ) ) {
        return ( void * ) table->GetBufferDeviceAddressKHR;
    }
    if ( !strcmp ( name, "GetBufferOpaqueCaptureAddressKHR" ) ) {
        return ( void * ) table->GetBufferOpaqueCaptureAddressKHR;
    }
    if ( !strcmp ( name, "GetDeviceMemoryOpaqueCaptureAddressKHR" ) ) {
        return ( void * ) table->GetDeviceMemoryOpaqueCaptureAddressKHR;
    }

    // ---- VK_KHR_pipeline_executable_properties extension commands
    if ( !strcmp ( name, "GetPipelineExecutablePropertiesKHR" ) ) {
        return ( void * ) table->GetPipelineExecutablePropertiesKHR;
    }
    if ( !strcmp ( name, "GetPipelineExecutableStatisticsKHR" ) ) {
        return ( void * ) table->GetPipelineExecutableStatisticsKHR;
    }
    ...
    if ( !strcmp ( name, "DebugMarkerSetObjectTagEXT" ) ) {
        return ( void * ) table->DebugMarkerSetObjectTagEXT;
    }
    if ( !strcmp ( name, "DebugMarkerSetObjectNameEXT" ) ) {
        return ( void * ) table->DebugMarkerSetObjectNameEXT;
    }
    if ( !strcmp ( name, "CmdDebugMarkerBeginEXT" ) ) {
        return ( void * ) table->CmdDebugMarkerBeginEXT;
    }
    if ( !strcmp ( name, "CmdDebugMarkerEndEXT" ) ) {
        return ( void * ) table->CmdDebugMarkerEndEXT;
    }
    if ( !strcmp ( name, "CmdDebugMarkerInsertEXT" ) ) {
        return ( void * ) table->CmdDebugMarkerInsertEXT;
    }

    // ---- VK_EXT_transform_feedback extension commands
    if ( !strcmp ( name, "CmdBindTransformFeedbackBuffersEXT" ) ) {
        return ( void * ) table->CmdBindTransformFeedbackBuffersEXT;
    }
    if ( !strcmp ( name, "CmdBeginTransformFeedbackEXT" ) ) {
        return ( void * ) table->CmdBeginTransformFeedbackEXT;
    }
    if ( !strcmp ( name, "CmdEndTransformFeedbackEXT" ) ) {
        return ( void * ) table->CmdEndTransformFeedbackEXT;
    }
    if ( !strcmp ( name, "CmdBeginQueryIndexedEXT" ) ) {
        return ( void * ) table->CmdBeginQueryIndexedEXT;
    }
    if ( !strcmp ( name, "CmdEndQueryIndexedEXT" ) ) {
        return ( void * ) table->CmdEndQueryIndexedEXT;
    }
    if ( !strcmp ( name, "CmdDrawIndirectByteCountEXT" ) ) {
        return ( void * ) table->CmdDrawIndirectByteCountEXT;
    }

    // ---- VK_NVX_image_view_handle extension commands
    if ( !strcmp ( name, "GetImageViewHandleNVX" ) ) {
        return ( void * ) table->GetImageViewHandleNVX;
    }

    // ---- VK_AMD_draw_indirect_count extension commands
    if ( !strcmp ( name, "CmdDrawIndirectCountAMD" ) ) {
        return ( void * ) table->CmdDrawIndirectCountAMD;
    }
    if ( !strcmp ( name, "CmdDrawIndexedIndirectCountAMD" ) ) {
        return ( void * ) table->CmdDrawIndexedIndirectCountAMD;
    }

    // ---- VK_AMD_shader_info extension commands
    if ( !strcmp ( name, "GetShaderInfoAMD" ) ) {
        return ( void * ) table->GetShaderInfoAMD;
    }

    // ---- VK_NV_external_memory_win32 extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetMemoryWin32HandleNV" ) ) {
        return ( void * ) table->GetMemoryWin32HandleNV;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR

    // ---- VK_EXT_conditional_rendering extension commands
    if ( !strcmp ( name, "CmdBeginConditionalRenderingEXT" ) ) {
        return ( void * ) table->CmdBeginConditionalRenderingEXT;
    }
    if ( !strcmp ( name, "CmdEndConditionalRenderingEXT" ) ) {
        return ( void * ) table->CmdEndConditionalRenderingEXT;
    }

    // ---- VK_NVX_device_generated_commands extension commands
    if ( !strcmp ( name, "CmdProcessCommandsNVX" ) ) {
        return ( void * ) table->CmdProcessCommandsNVX;
    }
    if ( !strcmp ( name, "CmdReserveSpaceForCommandsNVX" ) ) {
        return ( void * ) table->CmdReserveSpaceForCommandsNVX;
    }
    if ( !strcmp ( name, "CreateIndirectCommandsLayoutNVX" ) ) {
        return ( void * ) table->CreateIndirectCommandsLayoutNVX;
    }
    ...
    if ( !strcmp ( name, "CreateObjectTableNVX" ) ) {
        return ( void * ) table->CreateObjectTableNVX;
    }
    if ( !strcmp ( name, "DestroyObjectTableNVX" ) ) {
        return ( void * ) table->DestroyObjectTableNVX;
    }
    if ( !strcmp ( name, "RegisterObjectsNVX" ) ) {
        return ( void * ) table->RegisterObjectsNVX;
    }
    if ( !strcmp ( name, "UnregisterObjectsNVX" ) ) {
        return ( void * ) table->UnregisterObjectsNVX;
    }

    // ---- VK_NV_clip_space_w_scaling extension commands
    if ( !strcmp ( name, "CmdSetViewportWScalingNV" ) ) {
        return ( void * ) table->CmdSetViewportWScalingNV;
    }

    // ---- VK_EXT_display_control extension commands
    if ( !strcmp ( name, "DisplayPowerControlEXT" ) ) {
        return ( void * ) table->DisplayPowerControlEXT;
    }
    if ( !strcmp ( name, "RegisterDeviceEventEXT" ) ) {
        return ( void * ) table->RegisterDeviceEventEXT;
    }
    if ( !strcmp ( name, "RegisterDisplayEventEXT" ) ) {
        return ( void * ) table->RegisterDisplayEventEXT;
    }
    if ( !strcmp ( name, "GetSwapchainCounterEXT" ) ) {
        return ( void * ) table->GetSwapchainCounterEXT;
    }

    // ---- VK_GOOGLE_display_timing extension commands
    if ( !strcmp ( name, "GetRefreshCycleDurationGOOGLE" ) ) {
        return ( void * ) table->GetRefreshCycleDurationGOOGLE;
    }
    ...
    // ---- VK_EXT_discard_rectangles extension commands
    if ( !strcmp ( name, "CmdSetDiscardRectangleEXT" ) ) {
        return ( void * ) table->CmdSetDiscardRectangleEXT;
    }

    // ---- VK_EXT_hdr_metadata extension commands
    if ( !strcmp ( name, "SetHdrMetadataEXT" ) ) {
        return ( void * ) table->SetHdrMetadataEXT;
    }

    // ---- VK_EXT_debug_utils extension commands
    if ( !strcmp ( name, "SetDebugUtilsObjectNameEXT" ) ) {
        return ( void * ) table->SetDebugUtilsObjectNameEXT;
    }
    if ( !strcmp ( name, "SetDebugUtilsObjectTagEXT" ) ) {
        return ( void * ) table->SetDebugUtilsObjectTagEXT;
    }
    if ( !strcmp ( name, "QueueBeginDebugUtilsLabelEXT" ) ) {
        return ( void * ) table->QueueBeginDebugUtilsLabelEXT;
    }
    if ( !strcmp ( name, "QueueEndDebugUtilsLabelEXT" ) ) {
        return ( void * ) table->QueueEndDebugUtilsLabelEXT;
    }
    if ( !strcmp ( name, "QueueInsertDebugUtilsLabelEXT" ) ) {
        return ( void * ) table->QueueInsertDebugUtilsLabelEXT;
    }
    if ( !strcmp ( name, "CmdBeginDebugUtilsLabelEXT" ) ) {
        return ( void * ) table->CmdBeginDebugUtilsLabelEXT;
    }
    if ( !strcmp ( name, "CmdEndDebugUtilsLabelEXT" ) ) {
        return ( void * ) table->CmdEndDebugUtilsLabelEXT;
    }
    if ( !strcmp ( name, "CmdInsertDebugUtilsLabelEXT" ) ) {
        return ( void * ) table->CmdInsertDebugUtilsLabelEXT;
    }

    // ---- VK_ANDROID_external_memory_android_hardware_buffer extension commands
#ifdef VK_USE_PLATFORM_ANDROID_KHR
    if ( !strcmp ( name, "GetAndroidHardwareBufferPropertiesANDROID" ) ) {
        return ( void * ) table->GetAndroidHardwareBufferPropertiesANDROID;
    }
#endif // VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
    if ( !strcmp ( name, "GetMemoryAndroidHardwareBufferANDROID" ) ) {
        return ( void * ) table->GetMemoryAndroidHardwareBufferANDROID;
    }
#endif // VK_USE_PLATFORM_ANDROID_KHR

    // ---- VK_EXT_sample_locations extension commands
    if ( !strcmp ( name, "CmdSetSampleLocationsEXT" ) ) {
        return ( void * ) table->CmdSetSampleLocationsEXT;
    }

    // ---- VK_EXT_image_drm_format_modifier extension commands
    if ( !strcmp ( name, "GetImageDrmFormatModifierPropertiesEXT" ) ) {
        return ( void * ) table->GetImageDrmFormatModifierPropertiesEXT;
    }

    // ---- VK_EXT_validation_cache extension commands
    if ( !strcmp ( name, "CreateValidationCacheEXT" ) ) {
        return ( void * ) table->CreateValidationCacheEXT;
    }
    if ( !strcmp ( name, "DestroyValidationCacheEXT" ) ) {
        return ( void * ) table->DestroyValidationCacheEXT;
    }
    if ( !strcmp ( name, "MergeValidationCachesEXT" ) ) {
        return ( void * ) table->MergeValidationCachesEXT;
    }
    if ( !strcmp ( name, "GetValidationCacheDataEXT" ) ) {
        return ( void * ) table->GetValidationCacheDataEXT;
    }

    // ---- VK_NV_shading_rate_image extension commands
    if ( !strcmp ( name, "CmdBindShadingRateImageNV" ) ) {
        return ( void * ) table->CmdBindShadingRateImageNV;
    }
    if ( !strcmp ( name, "CmdSetViewportShadingRatePaletteNV" ) ) {
        return ( void * ) table->CmdSetViewportShadingRatePaletteNV;
    }
    if ( !strcmp ( name, "CmdSetCoarseSampleOrderNV" ) ) {
        return ( void * ) table->CmdSetCoarseSampleOrderNV;
    }

    // ---- VK_NV_ray_tracing extension commands
    if ( !strcmp ( name, "CreateAccelerationStructureNV" ) ) {
        return ( void * ) table->CreateAccelerationStructureNV;
    }
    if ( !strcmp ( name, "DestroyAccelerationStructureNV" ) ) {
        return ( void * ) table->DestroyAccelerationStructureNV;
    }
    if ( !strcmp ( name, "GetAccelerationStructureMemoryRequirementsNV" ) ) {
        return ( void * ) table->GetAccelerationStructureMemoryRequirementsNV;
    }
    if ( !strcmp ( name, "BindAccelerationStructureMemoryNV" ) ) {
        return ( void * ) table->BindAccelerationStructureMemoryNV;
    }
    if ( !strcmp ( name, "CmdBuildAccelerationStructureNV" ) ) {
        return ( void * ) table->CmdBuildAccelerationStructureNV;
    }
    if ( !strcmp ( name, "CmdCopyAccelerationStructureNV" ) ) {
        return ( void * ) table->CmdCopyAccelerationStructureNV;
    }
    if ( !strcmp ( name, "CmdTraceRaysNV" ) ) {
        return ( void * ) table->CmdTraceRaysNV;
    }
    if ( !strcmp ( name, "CreateRayTracingPipelinesNV" ) ) {
        return ( void * ) table->CreateRayTracingPipelinesNV;
    }
    if ( !strcmp ( name, "GetRayTracingShaderGroupHandlesNV" ) ) {
        return ( void * ) table->GetRayTracingShaderGroupHandlesNV;
    }
    if ( !strcmp ( name, "GetAccelerationStructureHandleNV" ) ) {
        return ( void * ) table->GetAccelerationStructureHandleNV;
    }
    if ( !strcmp ( name, "CmdWriteAccelerationStructuresPropertiesNV" ) ) {
        return ( void * ) table->CmdWriteAccelerationStructuresPropertiesNV;
    }
    if ( !strcmp ( name, "CompileDeferredNV" ) ) {
        return ( void * ) table->CompileDeferredNV;
    }

    // ---- VK_EXT_external_memory_host extension commands
    if ( !strcmp ( name, "GetMemoryHostPointerPropertiesEXT" ) ) {
        return ( void * ) table->GetMemoryHostPointerPropertiesEXT;
    }

    // ---- VK_AMD_buffer_marker extension commands
    if ( !strcmp ( name, "CmdWriteBufferMarkerAMD" ) ) {
        return ( void * ) table->CmdWriteBufferMarkerAMD;
    }

    // ---- VK_EXT_calibrated_timestamps extension commands
    if ( !strcmp ( name, "GetCalibratedTimestampsEXT" ) ) {
        return ( void * ) table->GetCalibratedTimestampsEXT;
    }

    // ---- VK_NV_mesh_shader extension commands
    if ( !strcmp ( name, "CmdDrawMeshTasksNV" ) ) {
        return ( void * ) table->CmdDrawMeshTasksNV;
    }
    if ( !strcmp ( name, "CmdDrawMeshTasksIndirectNV" ) ) {
        return ( void * ) table->CmdDrawMeshTasksIndirectNV;
    }
    if ( !strcmp ( name, "CmdDrawMeshTasksIndirectCountNV" ) ) {
        return ( void * ) table->CmdDrawMeshTasksIndirectCountNV;
    }

    // ---- VK_NV_scissor_exclusive extension commands
    if ( !strcmp ( name, "CmdSetExclusiveScissorNV" ) ) {
        return ( void * ) table->CmdSetExclusiveScissorNV;
    }

    // ---- VK_NV_device_diagnostic_checkpoints extension commands
    if ( !strcmp ( name, "CmdSetCheckpointNV" ) ) {
        return ( void * ) table->CmdSetCheckpointNV;
    }
    if ( !strcmp ( name, "GetQueueCheckpointDataNV" ) ) {
        return ( void * ) table->GetQueueCheckpointDataNV;
    }

    // ---- VK_INTEL_performance_query extension commands
    if ( !strcmp ( name, "InitializePerformanceApiINTEL" ) ) {
        return ( void * ) table->InitializePerformanceApiINTEL;
    }
    if ( !strcmp ( name, "UninitializePerformanceApiINTEL" ) ) {
        return ( void * ) table->UninitializePerformanceApiINTEL;
    }
    if ( !strcmp ( name, "CmdSetPerformanceMarkerINTEL" ) ) {
        return ( void * ) table->CmdSetPerformanceMarkerINTEL;
    }
    if ( !strcmp ( name, "CmdSetPerformanceStreamMarkerINTEL" ) ) {
        return ( void * ) table->CmdSetPerformanceStreamMarkerINTEL;
    }
    if ( !strcmp ( name, "CmdSetPerformanceOverrideINTEL" ) ) {
        return ( void * ) table->CmdSetPerformanceOverrideINTEL;
    }
    if ( !strcmp ( name, "AcquirePerformanceConfigurationINTEL" ) ) {
        return ( void * ) table->AcquirePerformanceConfigurationINTEL;
    }
    if ( !strcmp ( name, "ReleasePerformanceConfigurationINTEL" ) ) {
        return ( void * ) table->ReleasePerformanceConfigurationINTEL;
    }
    if ( !strcmp ( name, "QueueSetPerformanceConfigurationINTEL" ) ) {
        return ( void * ) table->QueueSetPerformanceConfigurationINTEL;
    }
    if ( !strcmp ( name, "GetPerformanceParameterINTEL" ) ) {
        return ( void * ) table->GetPerformanceParameterINTEL;
    }

    // ---- VK_AMD_display_native_hdr extension commands
    if ( !strcmp ( name, "SetLocalDimmingAMD" ) ) {
        return ( void * ) table->SetLocalDimmingAMD;
    }

    // ---- VK_EXT_buffer_device_address extension commands
    if ( !strcmp ( name, "GetBufferDeviceAddressEXT" ) ) {
        return ( void * ) table->GetBufferDeviceAddressEXT;
    }

    // ---- VK_EXT_full_screen_exclusive extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "AcquireFullScreenExclusiveModeEXT" ) ) {
        return ( void * ) table->AcquireFullScreenExclusiveModeEXT;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "ReleaseFullScreenExclusiveModeEXT" ) ) {
        return ( void * ) table->ReleaseFullScreenExclusiveModeEXT;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetDeviceGroupSurfacePresentModes2EXT" ) ) {
        return ( void * ) table->GetDeviceGroupSurfacePresentModes2EXT;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR

    // ---- VK_EXT_line_rasterization extension commands
    if ( !strcmp ( name, "CmdSetLineStippleEXT" ) ) {
        return ( void * ) table->CmdSetLineStippleEXT;
    }

    // ---- VK_EXT_host_query_reset extension commands
    if ( !strcmp ( name, "ResetQueryPoolEXT" ) ) {
        return ( void * ) table->ResetQueryPoolEXT;
    }
        ...
        bool *found_name )
{
    ...
    *found_name = true;
    ...
    // ---- Core 1_1 commands
    if ( !strcmp ( name, "EnumeratePhysicalDeviceGroups" ) ) {
        return ( void * ) table->EnumeratePhysicalDeviceGroups;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceFeatures2" ) ) {
        return ( void * ) table->GetPhysicalDeviceFeatures2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceProperties2" ) ) {
        return ( void * ) table->GetPhysicalDeviceProperties2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceFormatProperties2" ) ) {
        return ( void * ) table->GetPhysicalDeviceFormatProperties2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceImageFormatProperties2" ) ) {
        return ( void * ) table->GetPhysicalDeviceImageFormatProperties2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceQueueFamilyProperties2" ) ) {
        return ( void * ) table->GetPhysicalDeviceQueueFamilyProperties2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceMemoryProperties2" ) ) {
        return ( void * ) table->GetPhysicalDeviceMemoryProperties2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceSparseImageFormatProperties2" ) ) {
        return ( void * ) table->GetPhysicalDeviceSparseImageFormatProperties2;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceExternalBufferProperties" ) ) {
        return ( void * ) table->GetPhysicalDeviceExternalBufferProperties;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceExternalFenceProperties" ) ) {
        return ( void * ) table->GetPhysicalDeviceExternalFenceProperties;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceExternalSemaphoreProperties" ) ) {
        return ( void * ) table->GetPhysicalDeviceExternalSemaphoreProperties;
    }
    ...
    if ( !strcmp ( name, "GetPhysicalDevicePresentRectanglesKHR" ) ) {
        return ( void * ) table->GetPhysicalDevicePresentRectanglesKHR;
    }
    ...
    // ---- VK_KHR_android_surface extension commands
#ifdef VK_USE_PLATFORM_ANDROID_KHR
    if ( !strcmp ( name, "CreateAndroidSurfaceKHR" ) ) {
        return ( void * ) table->CreateAndroidSurfaceKHR;
    }
#endif // VK_USE_PLATFORM_ANDROID_KHR
    ...
    // ---- VK_KHR_device_group_creation extension commands
    if ( !strcmp ( name, "EnumeratePhysicalDeviceGroupsKHR" ) ) {
        return ( void * ) table->EnumeratePhysicalDeviceGroupsKHR;
    }

    // ---- VK_KHR_external_memory_capabilities extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceExternalBufferPropertiesKHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceExternalBufferPropertiesKHR;
    }

    // ---- VK_KHR_external_semaphore_capabilities extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceExternalSemaphorePropertiesKHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceExternalSemaphorePropertiesKHR;
    }

    // ---- VK_KHR_external_fence_capabilities extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceExternalFencePropertiesKHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceExternalFencePropertiesKHR;
    }

    // ---- VK_KHR_performance_query extension commands
    if ( !strcmp ( name, "EnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR" ) ) {
        return ( void * ) table->EnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR;
    }
    ...
    if ( !strcmp ( name, "GetPhysicalDeviceSurfaceFormats2KHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceSurfaceFormats2KHR;
    }

    // ---- VK_KHR_get_display_properties2 extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceDisplayProperties2KHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceDisplayProperties2KHR;
    }
    if ( !strcmp ( name, "GetPhysicalDeviceDisplayPlaneProperties2KHR" ) ) {
        return ( void * ) table->GetPhysicalDeviceDisplayPlaneProperties2KHR;
    }
    if ( !strcmp ( name, "GetDisplayModeProperties2KHR" ) ) {
        return ( void * ) table->GetDisplayModeProperties2KHR;
    }
    if ( !strcmp ( name, "GetDisplayPlaneCapabilities2KHR" ) ) {
        return ( void * ) table->GetDisplayPlaneCapabilities2KHR;
    }
    ...
    // ---- VK_GGP_stream_descriptor_surface extension commands
#ifdef VK_USE_PLATFORM_GGP
    if ( !strcmp ( name, "CreateStreamDescriptorSurfaceGGP" ) ) {
        return ( void * ) table->CreateStreamDescriptorSurfaceGGP;
    }
#endif // VK_USE_PLATFORM_GGP
    ...
    // ---- VK_NN_vi_surface extension commands
#ifdef VK_USE_PLATFORM_VI_NN
    if ( !strcmp ( name, "CreateViSurfaceNN" ) ) {
        return ( void * ) table->CreateViSurfaceNN;
    }
#endif // VK_USE_PLATFORM_VI_NN
    ...
    // ---- VK_MVK_ios_surface extension commands
#ifdef VK_USE_PLATFORM_IOS_MVK
    if ( !strcmp ( name, "CreateIOSSurfaceMVK" ) ) {
        return ( void * ) table->CreateIOSSurfaceMVK;
    }
#endif // VK_USE_PLATFORM_IOS_MVK
    ...
    if ( !strcmp ( name, "CreateMacOSSurfaceMVK" ) ) {
        return ( void * ) table->CreateMacOSSurfaceMVK;
    }
#endif // VK_USE_PLATFORM_MACOS_MVK

    // ---- VK_EXT_debug_utils extension commands
    if ( !strcmp ( name, "CreateDebugUtilsMessengerEXT" ) ) {
        return ( void * ) table->CreateDebugUtilsMessengerEXT;
    }
    if ( !strcmp ( name, "DestroyDebugUtilsMessengerEXT" ) ) {
        return ( void * ) table->DestroyDebugUtilsMessengerEXT;
    }
    if ( !strcmp ( name, "SubmitDebugUtilsMessageEXT" ) ) {
        return ( void * ) table->SubmitDebugUtilsMessageEXT;
    }

    // ---- VK_EXT_sample_locations extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceMultisamplePropertiesEXT" ) ) {
        return ( void * ) table->GetPhysicalDeviceMultisamplePropertiesEXT;
    }

    // ---- VK_EXT_calibrated_timestamps extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceCalibrateableTimeDomainsEXT" ) ) {
        return ( void * ) table->GetPhysicalDeviceCalibrateableTimeDomainsEXT;
    }

    // ---- VK_FUCHSIA_imagepipe_surface extension commands
#ifdef VK_USE_PLATFORM_FUCHSIA
    if ( !strcmp ( name, "CreateImagePipeSurfaceFUCHSIA" ) ) {
        return ( void * ) table->CreateImagePipeSurfaceFUCHSIA;
    }
#endif // VK_USE_PLATFORM_FUCHSIA

    // ---- VK_EXT_metal_surface extension commands
#ifdef VK_USE_PLATFORM_METAL_EXT
    if ( !strcmp ( name, "CreateMetalSurfaceEXT" ) ) {
        return ( void * ) table->CreateMetalSurfaceEXT;
    }
#endif // VK_USE_PLATFORM_METAL_EXT

    // ---- VK_EXT_tooling_info extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceToolPropertiesEXT" ) ) {
        return ( void * ) table->GetPhysicalDeviceToolPropertiesEXT;
    }

    // ---- VK_NV_cooperative_matrix extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceCooperativeMatrixPropertiesNV" ) ) {
        return ( void * ) table->GetPhysicalDeviceCooperativeMatrixPropertiesNV;
    }

    // ---- VK_NV_coverage_reduction_mode extension commands
    if ( !strcmp ( name, "GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV" ) ) {
        return ( void * ) table->GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV;
    }

    // ---- VK_EXT_full_screen_exclusive extension commands
#ifdef VK_USE_PLATFORM_WIN32_KHR
    if ( !strcmp ( name, "GetPhysicalDeviceSurfacePresentModes2EXT" ) ) {
        return ( void * ) table->GetPhysicalDeviceSurfacePresentModes2EXT;
    }
#endif // VK_USE_PLATFORM_WIN32_KHR

    // ---- VK_EXT_headless_surface extension commands
    if ( !strcmp ( name, "CreateHeadlessSurfaceEXT" ) ) {
