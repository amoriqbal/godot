...
static inline void *trampolineGetProcAddr ( struct loader_instance *inst, const char *funcName )
{
    ...
    // Core 1.1 functions
    if ( !strcmp ( funcName, "vkEnumeratePhysicalDeviceGroups" ) ) {
        return vkEnumeratePhysicalDeviceGroups;
    }
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceFeatures2" ) ) {
        return vkGetPhysicalDeviceFeatures2;
    }
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceProperties2" ) ) {
        return vkGetPhysicalDeviceProperties2;
    }
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceFormatProperties2" ) ) {
        return vkGetPhysicalDeviceFormatProperties2;
    }
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceImageFormatProperties2" ) ) {
        return vkGetPhysicalDeviceImageFormatProperties2;
    }
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceQueueFamilyProperties2" ) ) {
        return vkGetPhysicalDeviceQueueFamilyProperties2;
    }
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceMemoryProperties2" ) ) {
    ...
    if ( !strcmp ( funcName, "vkGetPhysicalDeviceExternalFenceProperties" ) ) {
        return vkGetPhysicalDeviceExternalFenceProperties;
    }
    if ( !strcmp ( funcName, "vkBindBufferMemory2" ) ) {
        return vkBindBufferMemory2;
    }
    if ( !strcmp ( funcName, "vkBindImageMemory2" ) ) {
        return vkBindImageMemory2;
    }
    if ( !strcmp ( funcName, "vkGetDeviceGroupPeerMemoryFeatures" ) ) {
        return vkGetDeviceGroupPeerMemoryFeatures;
    }
    if ( !strcmp ( funcName, "vkCmdSetDeviceMask" ) ) {
        return vkCmdSetDeviceMask;
    }
    if ( !strcmp ( funcName, "vkCmdDispatchBase" ) ) {
        return vkCmdDispatchBase;
    }
    if ( !strcmp ( funcName, "vkGetImageMemoryRequirements2" ) ) {
        return vkGetImageMemoryRequirements2;
    }
    if ( !strcmp ( funcName, "vkTrimCommandPool" ) ) {
        return vkTrimCommandPool;
    }
    if ( !strcmp ( funcName, "vkGetDeviceQueue2" ) ) {
        return vkGetDeviceQueue2;
    }
    if ( !strcmp ( funcName, "vkCreateSamplerYcbcrConversion" ) ) {
        return vkCreateSamplerYcbcrConversion;
    }
    if ( !strcmp ( funcName, "vkDestroySamplerYcbcrConversion" ) ) {
        return vkDestroySamplerYcbcrConversion;
    }
    if ( !strcmp ( funcName, "vkGetDescriptorSetLayoutSupport" ) ) {
        return vkGetDescriptorSetLayoutSupport;
    }
    if ( !strcmp ( funcName, "vkCreateDescriptorUpdateTemplate" ) ) {
        return vkCreateDescriptorUpdateTemplate;
    }
    if ( !strcmp ( funcName, "vkDestroyDescriptorUpdateTemplate" ) ) {
        return vkDestroyDescriptorUpdateTemplate;
    }
    if ( !strcmp ( funcName, "vkUpdateDescriptorSetWithTemplate" ) ) {
        return vkUpdateDescriptorSetWithTemplate;
    }
    if ( !strcmp ( funcName, "vkGetImageSparseMemoryRequirements2" ) ) {
        return vkGetImageSparseMemoryRequirements2;
    }
    if ( !strcmp ( funcName, "vkGetBufferMemoryRequirements2" ) ) {
        return vkGetBufferMemoryRequirements2;
    }

    // Core 1.2 functions
    if ( !strcmp ( funcName, "vkCreateRenderPass2" ) ) {
        return vkCreateRenderPass2;
    }
    if ( !strcmp ( funcName, "vkCmdBeginRenderPass2" ) ) {
        return vkCmdBeginRenderPass2;
    }
    if ( !strcmp ( funcName, "vkCmdNextSubpass2" ) ) {
        return vkCmdNextSubpass2;
    }
    if ( !strcmp ( funcName, "vkCmdEndRenderPass2" ) ) {
        return vkCmdEndRenderPass2;
    }
    if ( !strcmp ( funcName, "vkCmdDrawIndirectCount" ) ) {
        return vkCmdDrawIndirectCount;
    }
    if ( !strcmp ( funcName, "vkCmdDrawIndexedIndirectCount" ) ) {
        return vkCmdDrawIndexedIndirectCount;
    }
    if ( !strcmp ( funcName, "vkGetSemaphoreCounterValue" ) ) {
        return vkGetSemaphoreCounterValue;
    }
    if ( !strcmp ( funcName, "vkWaitSemaphores" ) ) {
        return vkWaitSemaphores;
    }
    if ( !strcmp ( funcName, "vkSignalSemaphore" ) ) {
        return vkSignalSemaphore;
    }
    if ( !strcmp ( funcName, "vkGetBufferDeviceAddress" ) ) {
        return vkGetBufferDeviceAddress;
    }
    if ( !strcmp ( funcName, "vkGetBufferOpaqueCaptureAddress" ) ) {
        return vkGetBufferOpaqueCaptureAddress;
    }
    if ( !strcmp ( funcName, "vkGetDeviceMemoryOpaqueCaptureAddress" ) ) {
        return vkGetDeviceMemoryOpaqueCaptureAddress;
    }
    if ( !strcmp ( funcName, "vkResetQueryPool" ) ) {
        return vkResetQueryPool;
    }

    // Instance extensions
    void *addr;
    if ( debug_utils_InstanceGpa ( inst, funcName, &addr ) ) {
        return addr;
    }
