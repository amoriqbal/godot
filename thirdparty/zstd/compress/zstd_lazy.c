    ...
    while ( nbCompares-- && ( matchIndex > windowLow ) ) {
        ...
        if ( match[matchLength] < ip[matchLength] ) { /* necessarily within buffer */
            ...
            *smallerPtr = matchIndex;             /* update smaller idx */
            ...
            if ( matchIndex <= btLow ) {
                smallerPtr=&dummy32;    /* beyond tree size, stop searching */
                break;
            }
            ...
            *largerPtr = matchIndex;
            ...
            if ( matchIndex <= btLow ) {
                largerPtr=&dummy32;    /* beyond tree size, stop searching */
                break;
            }
        ...
        while ( nbCompares-- && ( matchIndex > windowLow ) ) {
            ...
            if ( match[matchLength] < ip[matchLength] ) {
                ...
                *smallerPtr = matchIndex;             /* update smaller idx */
                commonLengthSmaller = matchLength;    /* all smaller will now have at least this guaranteed common length */
                if ( matchIndex <= btLow ) {
                    smallerPtr=&dummy32;    /* beyond tree size, stop the search */
                    break;
                }
                ...
                *largerPtr = matchIndex;
                commonLengthLarger = matchLength;
                if ( matchIndex <= btLow ) {
                    largerPtr=&dummy32;    /* beyond tree size, stop the search */
                    break;
                }
                largerPtr = nextPtr;
                matchIndex = nextPtr[0];
